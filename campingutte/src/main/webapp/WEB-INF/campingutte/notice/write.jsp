		...
		<form name="boardForm" method="post">
			<table class="table table-border table-form">
				<tr> 
					<td>제&nbsp;&nbsp;&nbsp;&nbsp;목</td>
					<td> 
						<input type="text" name="notiSubject" maxlength="100" class="boxTF" value="${dto.notiSubject}">
					</td>
				</tr>
				...
				<tr> 
					...
					<td> 
						<textarea name="notiContent" class="boxTA">${dto.notiContent}</textarea>
					</td>
				</tr>
			</table>
