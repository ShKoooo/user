		...
		<form name="boardForm" method="post">
			<table class="table table-border table-form">
				<tr> 
					<td>제&nbsp;&nbsp;&nbsp;&nbsp;목</td>
					<td> 
						<input type="text" name="commSubject" maxlength="100" class="boxTF" value="${dto.commSubject}">
					</td>
				</tr>
				...
				<tr> 
					...
					<td> 
						<textarea name="commContent" class="boxTA">${dto.commContent}</textarea>
					</td>
				</tr>
			</table>
			...
			<table class="table">
				<tr> 
					<td align="center">
						...
						<button type="button" class="btn" onclick="location.href='${pageContext.request.contextPath}/community/list.do';">${mode=='update'?'수정취소':'등록취소'}</button>
						<c:if test="${mode=='update'}">
							<input type="hidden" name="boardNum" value="${dto.commNo}">
