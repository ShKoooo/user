		...
		<jsp:include page="/WEB-INF/campingutte/layout/header.jsp"></jsp:include>
                        	...
                        	<tbody>
                        		<tr>
                        			<td>
                        				...
                        				<span class="price1" style="font-size: 20px;" data-price="30000">30000원(수량변경불가!!)</span><br>
			...
			<div class="accordion-item">
				<h2 class="accordion-header" id="flush-heading-1">
					...
					<button class="accordion-button collapsed bg-light" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse-1" aria-expanded="false" aria-controls="flush-collapse-1">
					 <input type="checkbox" style="margin-right: 10px;"> 취소 및 환불 수수료에 동의합니다.
					</button>
				</h2>
			...
			<div class="accordion-item">
				<h2 class="accordion-header" id="flush-heading-2">
					<button class="accordion-button collapsed bg-light" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse-2" aria-expanded="false" aria-controls="flush-collapse-2">
						<input type="checkbox" style="margin-right: 10px;"> 이용 시 주의사항에 동의합니다.
					</button>
				</h2>
			...
			<div class="accordion-item">
				<h2 class="accordion-header" id="flush-heading-3">
					<button class="accordion-button collapsed bg-light" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse-3" aria-expanded="false" aria-controls="flush-collapse-3">
						<input type="checkbox" style="margin-right: 10px;"> 개인 정보 수집 및 이용에 동의합니다.
					</button>
				</h2>
			...
			<div class="accordion-item">
				<h2 class="accordion-header" id="flush-heading-1">
					...
					<button class="accordion-button collapsed bg-light" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse-4" aria-expanded="false" aria-controls="flush-collapse-4">
					 <input type="checkbox" style="margin-right: 10px;"> 개인 정보 제 3자 제공에 동의합니다.
					</button>
				</h2>
				<div id="flush-collapse-4" class="accordion-collapse collapse" aria-labelledby="flush-heading-4" data-bs-parent="#accordionFlush">
					<div class="accordion-body">
						<ul>
			...
			<div class="accordion-item">
				<h2 class="accordion-header" id="flush-heading-5">
					...
					<button class="accordion-button collapsed bg-light" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse-5" aria-expanded="false" aria-controls="flush-collapse-5">
					 <input type="checkbox" style="margin-right: 10px;"> 예약자는 성인이며, 서비스 이용약관에 동의합니다.
					</button>
				</h2>
				<div id="flush-collapse-5" class="accordion-collapse collapse" aria-labelledby="flush-heading-5" data-bs-parent="#accordionFlush">
					<div class="accordion-body">
						<ul>
