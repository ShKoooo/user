...
public class BoardServlet extends MyServlet {
	...
	private void writeSubmit(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			dto.setNotiSubject(req.getParameter("notiSubject"));
			dto.setNotiContent(req.getParameter("notiContent"));
	...
	private void article(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			// 조회수 증가
			dao.updateHitCount(notiNo);

			// 게시물 가져오기
			BoardDTO dto = dao.readBoard(notiNo);
			if (dto == null) {
			...
			forward(req, resp, "/WEB-INF/campingutte/notice/article.jsp");
			return;
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	private void updateSubmit(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			BoardDTO dto = new BoardDTO();
			dto.setNotiNo(Integer.parseInt(req.getParameter("notiNo")));
			dto.setNotiSubject(req.getParameter("notiSubject"));
			dto.setNotiContent(req.getParameter("notiContent"));
	...
	private void delete(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			dao.deleteBoard(notiNo, info.getMemberId());
		} catch (Exception e) {
			e.printStackTrace();
		}
